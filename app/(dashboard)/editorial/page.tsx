...
export default function EditorialPage() {
    ...
    return (
        <div className="flex flex-col h-full bg-zinc-50 dark:bg-zinc-950 overflow-hidden">
            <header className="h-16 border-b flex items-center justify-between px-6 bg-white dark:bg-zinc-900 shrink-0 z-30">
                <div className="flex items-center gap-4">
                    <div className="w-10 h-10 bg-zinc-900 dark:bg-white rounded-xl flex items-center justify-center rotate-3 hover:rotate-0 transition-transform cursor-pointer shadow-lg">
            ...
            <div className="flex-1 flex overflow-hidden">
                ...
                <aside className="w-full lg:w-[450px] border-r bg-white dark:bg-zinc-900 flex flex-col shrink-0 relative z-20 overflow-hidden shadow-xl">
                    <AnimatePresence mode="wait">
                        {sidebarMode === 'controls' ? (
                            ...
                            >
                                <div className="flex-1 overflow-y-auto p-6 space-y-8 scrollbar-thin">
                                    ...
                                    <section className="space-y-3">
                                        ...
                                        <div className="relative group">
                                            {modelImage ? (
                                                ...
                                                <label className="flex flex-col items-center justify-center h-24 rounded-xl border-2 border-dashed border-zinc-200 dark:border-zinc-800 hover:border-violet-500 hover:bg-violet-50/50 dark:hover:bg-violet-500/5 transition-all cursor-pointer">
                                                    <div className="flex items-center gap-3">
                                    ...
                                    <section className="space-y-3 px-1">
                                        <label className="text-xs font-bold text-muted-foreground uppercase tracking-widest flex items-center justify-between gap-2">
                                            ...
                                            <button
                                                className="text-violet-600 text-[10px] font-bold hover:underline bg-violet-500/5 px-2 py-0.5 rounded-full"
                                        ...
                                        {selectedBackground ? (
                                            <div className="relative group rounded-xl overflow-hidden border-2 border-zinc-200 dark:border-zinc-800 h-32 cursor-pointer group shadow-sm hover:shadow-md transition-all" onClick={() => setSidebarMode('library')}>
                                                ...
                                                <div className="absolute top-2 right-2 flex gap-1">
                                                    <div className="bg-black/40 backdrop-blur-md px-1.5 py-0.5 rounded-md border border-white/10">
                                            ...
                                            <button
                                                onClick={() => setSidebarMode('library')}
                                                className="w-full h-24 rounded-xl border-2 border-dashed border-zinc-200 dark:border-zinc-800 flex flex-col items-center justify-center hover:border-violet-500 hover:bg-violet-50 dark:hover:bg-violet-500/5 transition-all group"
                                            >
                                    ...
                                    <section className="space-y-4">
                                        <div className="space-y-1.5">
                                            ...
                                            <select
                                                className="w-full h-10 px-3 rounded-lg border bg-zinc-50 dark:bg-zinc-800 text-xs focus:ring-1 focus:ring-violet-500 outline-none"
                                                value={aspectRatio}
                                ...
                                {/* Action Section */}
                                <div className="p-6 border-t bg-white/80 dark:bg-zinc-900/80 backdrop-blur-xl shrink-0">
                                    <button
                            ...
                            <motion.div
                                ...
                                animate={{ opacity: 1, x: 0 }}
                                exit={{ opacity: 0, x: 20 }}
                                className="flex-1 flex flex-col overflow-hidden bg-zinc-50 dark:bg-zinc-950"
                            >
                                {/* Library Header */}
                                ...
                                <div className="flex-1 flex overflow-hidden">
                                    ...
                                    <div className="w-20 border-r border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 overflow-y-auto flex flex-col scrollbar-none">
                                    ...
                                    <div className="flex-1 flex flex-col overflow-hidden bg-zinc-50 dark:bg-zinc-950">
                                        {isAddMode ? (
                                                ...
                                                <div className="space-y-4">
                                                        ...
                                                        <>
                                                            <div className="space-y-1.5">
                                                                ...
                                                                <Input
                                                                    ...
                                                                    className="h-9 bg-white dark:bg-zinc-900 border-zinc-200 dark:border-zinc-800 text-xs"
                                                    ...
                                                    <div className="space-y-1.5">
                                                        ...
                                                        <div className="relative group/add">
                                                            {newLoc.image ? (
                                                                ...
                                                                <label className="flex flex-col items-center justify-center aspect-square rounded-xl border-2 border-dashed border-zinc-200 dark:border-zinc-800 hover:border-violet-500 transition-all cursor-pointer">
                                                    ...
                                                    <div className="space-y-1.5">
                                                        ...
                                                        <textarea
                                                            ...
                                                            className="w-full min-h-[100px] bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl p-3 text-xs focus:ring-1 focus:ring-violet-500 outline-none"
                                                            value={newLoc.prompt}
                                            ...
                                            <>
                                                <div className="p-3 flex gap-2 overflow-x-auto border-b border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 scrollbar-none">
                                                    {selectedLocation.cities.map((city) => (
                                                        <button
                                                            ...
                                                            className={`px-3 py-1 rounded-full whitespace-nowrap text-[9px] font-bold transition-all border
                                                                            ${selectedCity?.id === city.id ? 'bg-violet-600 border-violet-600 text-white' : 'text-zinc-500 border-zinc-200 dark:border-zinc-800 hover:border-violet-500/50'}
                                                                        `}
                                                        >
                                                                    ...
                                                                    <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-2">
                                                                        ...
                                                                        {img.id.startsWith('img-') && (
                                                                            <button
                                                                                ...
                                                                                className="p-1.5 bg-zinc-900/50 hover:bg-zinc-900 text-white rounded-full backdrop-blur-md transition-all"
                                                                            >
                                                                                <Pencil size={12} />
                                                                            </button>
                                                                        )}
                ...
                {/* Right Panel: Preview */}
                <main className="flex-1 bg-zinc-100 dark:bg-[#09090b] p-6 lg:p-10 flex flex-col gap-10 overflow-y-auto relative perspective-1000">
                    <div className="fixed inset-0 bg-[radial-gradient(circle_at_50%_0%,rgba(124,58,237,0.08),transparent_50%)] pointer-events-none" />

                    {/* Active Preview */}
                    <div className="flex-1 min-h-[500px] rounded-3xl bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 overflow-hidden relative shadow-2xl group/preview ring-1 ring-black/5 dark:ring-white/5">
                        {/* Camera HUD Overlay */}
                        <div className="absolute inset-0 z-20 pointer-events-none p-6 flex flex-col justify-between opacity-40 group-hover/preview:opacity-100 transition-opacity duration-700">
                            ...
                            <div className="flex justify-between items-start">
                                <div className="flex flex-col gap-1">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span className="text-[10px] font-mono font-bold tracking-[0.2em] text-zinc-900 dark:text-white uppercase">REC STUDIO 4K</span>
                                    </div>
                                    <span className="text-[8px] font-mono text-zinc-500">ISO 100 • {focalLength}mm • {aperture}</span>
                                </div>
                                <div className="text-right">
                                    <p className="text-[10px] font-mono font-bold text-zinc-900 dark:text-white mb-1">RAW • PRORES 422</p>
                                    <div className="w-12 h-0.5 bg-zinc-200 dark:bg-zinc-800 overflow-hidden rounded-full">
                            ...
                            <div className="flex justify-between items-end">
                                <div className="flex gap-4">
                                    <div className="flex flex-col gap-0.5">
                                        ...
                                        <span className="text-[10px] font-mono font-bold text-zinc-900 dark:text-white">MANUAL</span>
                                    </div>
                                    <div className="flex flex-col gap-0.5">
                                        <span className="text-[8px] text-zinc-500 font-bold">WB</span>
                                        <span className="text-[10px] font-mono font-bold text-zinc-900 dark:text-white">AUTO</span>
                                    </div>
                                </div>
                                <div className="flex flex-col items-end gap-0.5">
                                    <span className="text-[8px] text-zinc-500 font-bold">BATTERY</span>
                                    <div className="flex items-center gap-1.5 font-mono text-[10px] font-bold text-zinc-900 dark:text-white">
                            ...
                            <div className="absolute top-0 left-0 w-8 h-8 border-t-2 border-l-2 border-zinc-900 dark:border-white opacity-20" />
                            <div className="absolute top-0 right-0 w-8 h-8 border-t-2 border-r-2 border-zinc-900 dark:border-white opacity-20" />
                            <div className="absolute bottom-0 left-0 w-8 h-8 border-b-2 border-l-2 border-zinc-900 dark:border-white opacity-20" />
                            <div className="absolute bottom-0 right-0 w-8 h-8 border-b-2 border-r-2 border-zinc-900 dark:border-white opacity-20" />
                        </div>

                        {isProcessing ? (
                            <div className="absolute inset-0 z-30 bg-white/90 dark:bg-zinc-950/90 backdrop-blur-xl flex flex-col items-center justify-center p-10 text-center">
                        ...
                        {resultImages.length > 0 ? (
                            <img src={resultImages[0]} className="w-full h-full object-contain bg-zinc-900 shadow-inner" alt="Result" />
                        ) : (
                            <div className="w-full h-full flex flex-col items-center justify-center p-12 text-center relative overflow-hidden">
                                ...
                                <Camera className="w-24 h-24 text-zinc-900 dark:text-zinc-100 mb-8 opacity-20" />
            ...
            <Dialog open={showApprovalDialog} onOpenChange={setShowApprovalDialog}>
                <DialogContent className="max-w-2xl bg-zinc-950 border-white/5 text-white overflow-hidden p-0 rounded-[30px]">
