...
export const LOWER_SHOTS = [
    ...
    { id: 'technical_threequarter_front', label: 'Ön Yan Boy', labelEn: '3/4 Front Full Body', descriptionTr: 'Ön yan profil teknik çekim.', descriptionEn: '3/4 front technical shot.', image: '/crops/on_yan_boy.jpg', shotType: 'technical', faceProminence: 'full' },
...
export const STANDARD_SHOTS = [
    ...
    { id: 'std_tech_threequarter_front', label: 'Ön Yan Boy', labelEn: '3/4 Front Full Body', descriptionTr: 'Tam boy ön yan profil, kollar yanlarda.', descriptionEn: '3/4 front full body, arms at sides.', image: '/crops/on_yan_boy.jpg', shotType: 'technical', faceProminence: 'full' },
