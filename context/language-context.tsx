...
const translations: Translations = {
    ...
    "sidebar.photoshoot": { en: "Photoshoot", tr: "Çekim" },
    "sidebar.tools": { en: "Tools", tr: "Araçlar" },
    "sidebar.library": { en: "Library", tr: "Kütüphane" },
    "sidebar.resize": { en: "Resize", tr: "Boyutla" },
    "sidebar.techPack": { en: "Tech Pack", tr: "Teknik Dosya" },
    "sidebar.train": { en: "Train", tr: "Eğit" },
    ...
    // Home Page
    "home.welcome": { en: "Welcome back, Özgür KILIÇ", tr: "Tekrar hoş geldin, Özgür KILIÇ" },
    ...
    "home.photoshootTitle": { en: "Photoshoot", tr: "Fotoğraf Çek" },
    ...
    "home.virtualTryOn": { en: "Virtual Try-On", tr: "Deneme Kabini" },
    ...
    "home.ghostModelTitle": { en: "Ghost Model", tr: "Hayalet Manken" },
    ...
    "home.trainTitle": { en: "Train AI", tr: "AI Eğit" },
    ...
    "settings.billing": { en: "Billing", tr: "Fatura" },
    "settings.billingCredits": { en: "Billing & Credits", tr: "Fatura & Krediler" },
